...
Attraverso questo progetto ho voluto studiare le relazioni tra le caratteristiche principali dei motori delle automobili, dal 1950 ad oggi.
...
Nel corso degli anni lo sviluppo tecnologico ha portato le auto ad avere più cavalli e meno cilindrata.

Data la tendenza emersa segue un'analisi singola per i due valori.

## Analisi temporale singola 

Il primo valore tende a diminuire, mentre nel secondo caso è presente una buona tendenza crescente.
...
Dunque le case produttrici, per mantenere i valori dei loro modelli, devono aumentare leggermente le prestazioni del motore. L'opzione più semplice è di aumentare la cilindrata e probabilmente anche per questo motivo il grafico dell'andamento di questo valore nel tempo, mostrava una riduzione relativamente contenuta.
...
Il prezzo elevato delle auto esotiche garantisce motori con prestazioni decisamente elevate.
...
Pone in relazione i diversi segmenti di auto, utilizzando i cavalli per litro sull'asse x e il consumo del carburante sull'asse y.
